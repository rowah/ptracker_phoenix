defmodule PtrackerWeb.ProductControllerTest do
  use PtrackerWeb.ConnCase

  import Ptracker.StoreFixtures

  @create_attrs %{description: "some description", expiry_date: ~D[2023-02-16], image: "some image", manufacture_date: ~D[2023-02-16], name: "some name"}
